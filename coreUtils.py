...
from baseUtils import log, valid_files, valid_dirs


def par_thread(iterable, func, /, max_workers = None, thread_name_prefix = '', timeout = None, check_files = False, check_dirs = False, **kwargs):
